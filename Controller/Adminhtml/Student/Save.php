...
namespace CodeAesthetix\School\Controller\Adminhtml\Student;

use Magento\Framework\App\Action\HttpPostActionInterface;
use Magento\Backend\App\Action\Context;
use CodeAesthetix\School\Api\StudentRepositoryInterface;
use CodeAesthetix\School\Model\StudentFactory;
...
class Save extends Action implements HttpPostActionInterface
{
    ...
    public function execute(): ResultInterface
    {
        ...
        if ($data) {
            ...
            /** @var \CodeAesthetix\School\Model\Student $student */
     ...
     *
     * @param \CodeAesthetix\School\Model\Student $student
     * @param array $data
     * @param ResultInterface $resultRedirect
     * @return ResultInterface
     */
    private function processStudentReturn(\CodeAesthetix\School\Model\Student $student, array $data, ResultInterface $resultRedirect): ResultInterface
    {
