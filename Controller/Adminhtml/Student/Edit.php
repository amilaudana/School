...
class Edit extends \CodeAesthetix\School\Controller\Adminhtml\Student implements HttpGetActionInterface
{
    /**
     * @var PageFactory
     */
    ...
    {
        return $this->_authorization->isAllowed('CodeAesthetix_School::student');
    }
}
