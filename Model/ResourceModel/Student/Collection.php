<?php
namespace CodeAesthetix\School\Model\ResourceModel\Student;

use CodeAesthetix\School\Api\Data\StudentInterface;
use CodeAesthetix\School\Model\ResourceModel\AbstractCollection;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(\CodeAesthetix\School\Model\Student::class, \CodeAesthetix\School\Model\ResourceModel\Student::class);
